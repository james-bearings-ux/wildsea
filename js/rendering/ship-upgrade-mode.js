...
export function renderShipUpgradeMode(container, ship, gameData) {
  ...
  html += '<button data-action="setShipMode" data-params=\'{"mode":"creation"}\' style="background: #6B7280; color: white; padding: 8px 16px; border-radius: 4px; border: none; cursor: pointer; font-weight: 600;">Creation</button>';
  ...
  html += '<button data-action="setShipMode" data-params=\'{"mode":"upgrade"}\' style="background: #A91D3A; color: white; padding: 8px 16px; border-radius: 4px; border: none; cursor: pointer; font-weight: 600;">Upgrade</button>';
  html += '</div>';
